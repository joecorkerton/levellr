...
- Add deterministic unit/contract tests for normalization, date windows, stable ties, fixture retrieval, and no-results behavior. The three fixture queries in issue 02 must exercise this path without API credentials or a database.
