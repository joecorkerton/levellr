...
Given the chosen evidence-pack approach, observed corpus themes, and verified model interface, define the response contract and evaluation acceptance bar. The required BM25-first path must meet it before the optional hybrid retrieval upgrade.
